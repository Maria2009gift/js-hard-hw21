...
async function getPosts() {
    try {
        ...
        if (!response.ok) throw new Error("\u0421\u0442\u0430\u043B\u0430\u0441\u044C \u043F\u043E\u043C\u0438\u043B\u043A\u0430, \u0432\u0456\u0434\u043F\u043E\u0432\u0456\u0434\u044C \u0431\u0443\u043B\u0430 \u043D\u0435\u0432\u0434\u0430\u043B\u0430!");
...
async function createPost(title, content) {
    try {
        ...
        if (!response.ok) throw new Error("\u0412\u0456\u0434\u043F\u043E\u0432\u0456\u0434\u044C \u0432\u0456\u0434 \u0431\u0435\u043A\u0435\u043D\u0434\u0443 \u0431\u0443\u043B\u0430 \u043D\u0435\u0432\u0434\u0430\u043B\u043E\u044E");
        const data = await response.json();
        return data;
    } catch (error) {
        console.error(error);
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire0e6e")
